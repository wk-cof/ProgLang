...
class Point < GeometryValue
  ...
  def intersectPoint p
    real_close_point(p.x, p.y, x, y)   ? self : NoPoints.new()
  end
...
class Line < GeometryValue
  ...
  def intersectPoint pt
    real_close(pt.y, m * pt.x + b) ? self : NoPoints.new()
  end
...
class VerticalLine < GeometryValue
  ...
  def intersectPoint pt
    real_close(x, pt.x)? self : NoPoints.new()
  end
  ...
  def intersectVerticalLine vl
    real_close(x, vl.x)? self : NoPoints.new()
  end
  ...
  def preprocess_prog
    ...
    then
      ...
      then Point.new(x1,y1)
            ...
            if y1 < y2
            then LineSegment.new(x1,y1,x2,y2)
...
class Let < GeometryExpression
  ...
  def eval_prog env
    @e2.eval_prog env.concat([[s, @e1.eval_prog(env)]])
  end
end
